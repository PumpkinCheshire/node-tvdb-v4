...
export function expectNullableNumber( value: any ) {
	expect( value ).to.satisfy( ( _: any ) => typeof value === "number" || value === null, "expected nulllable number:" + value )
}
...
export function expectNullableString( value: any ) {
	expect( value ).to.satisfy( ( _: any ) => typeof value === "string" || value === null, "expected nullable string:" + value )
}
